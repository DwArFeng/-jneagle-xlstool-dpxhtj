...
public class DataImportPanel extends JPanel {
    ...
    private static final long serialVersionUID = 8530551102974254686L;
    ...
    public void postConstruct() {
        ...
        // 加载文件标签。
        JLabel loadFileLabel = new JLabel("加载文件");
...
//        passwordField.getDocument().addDocumentListener(new PasswordDocumentListener()); TODO
        ...
        // 读取文件按钮。
//        loadFileButton.setAction(new LoadFileAction()); TODO
        loadFileButton.setText("加载");
